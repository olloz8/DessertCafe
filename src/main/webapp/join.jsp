    ...
    <div class="login-wrapper">
                   ...
                   <form method = "post" action="joinAction.jsp" id="login-form">                     
                        ...
                        <input type ="text"placeholder="이름" name ="userName" maxlength='20'>
                        	...
                        	<br>
                    		<input type="radio" class="btn btn-primary form-control" name="userGender" autocomplete="off" value="남자" checked >남자
                    		<input type="radio" class="btn btn-primary form-control" name="userGender" autocomplete="off" value="여자" checked>여자
                    		</label>
                    	<br>

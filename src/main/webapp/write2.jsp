...
<body>
    ...
    <div id="wrap">
    	...
    	<table>
    		...
    		<tbody>
    			<tr>
    				<td><input type="text" class="form-control" placeholder="글 제목" name="noticeTitle" maxlength="50" style="width : 100%"></td>
    			</tr>
    			<tr>
    				<td><textarea class="form-control" placeholder="글 내용" name="noticeContent" maxlength="2048" style="height : 350px; width : 100%"></textarea></td>
    			</tr>
    		</tbody>
    	</table>
